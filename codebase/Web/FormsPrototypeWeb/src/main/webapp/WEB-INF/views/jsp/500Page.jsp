...
<body>
	<div class=" center">
		<h1>
			Internal server error <small><font face="Tahoma" color="red">Error	500</font></small>
		</h1>
		<br />
		<p>
			An internal server error ocurred while processing your request <br />
			Our Engineers have been notified of the problem and the issue will be resolved soon<br/>
			Use your browsers <b>Back</b> button to
